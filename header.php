	...
	<div class="site-content-contain">
		<div id="content" class="site-content">
			...
			<div class="wrap bg67r">
				...
				<div class="col">
					<h1>つぎ、つぎ、つぐ。</h1>
					<p>kanakenoは上質な白湯を提供する鉄瓶屋です。kanakenoの鉄瓶でつくった白湯は、余計なものが削ぎ落とされ、とてもまろやかになり、鉄分も摂れます。<br>
					そんな白湯をずっと楽しんでいただくため、永く気軽に鉄瓶をお使いいただくために、kanakenoは、鉄瓶と共に『はぐくむサービス』をご提供します。<br>
					kanakenoは、白湯を注ぎ、伝統を継ぎ、皆様を嗣ぐ鉄瓶屋であり続けます。</p>
					<a href="./about/">more <img class="arrow" src="<?php print get_template_directory_uri() . "/assets/images/arrow.png" ?>" alt=""></a>
				</div>
			</div>

			<h1 class="tac">kanakenoの「はぐくむサービス」</h1>
			<div class="wrap col3">
				<div>
					<img src="<?php print wp_upload_dir("2017/08")["url"] . "/main-02.jpg" ?>" alt="">
					<h2>育む<small>／永久保証</small></h2>
					<p>失敗しても大丈夫。２回まで無料でサビ/着色のお直しを致します。<br>
					「錆びてしまった」「空焚きしたら真っ赤になった」「永く使って少しくたびれた鉄瓶を新品のようにしたい」こんなお悩みに職人が対応致します。</p>
					<a href="./service/#guarantee">more <img class="arrow" src="<?php print get_template_directory_uri() . "/assets/images/arrow.png" ?>" alt=""></a>
				</div>
				<div>
					<img src="<?php print wp_upload_dir("2017/08")["url"] . "/main-03.jpg" ?>" alt="">
					<h2>HUG<small>／日常サポート</small></h2>
					<p>鉄瓶は日々使う事で育てるもの。<br>でも少しずつ変わっていく鉄瓶の変化（色、湯垢等）がいいのか悪いのか、
その違いを見分けるのは最初難しいものです。鉄瓶をご愛用いただく中でのお手入れ方法、疑問などに「鉄瓶コンシェルジュ」がお答えします。</p>
					<a href="./service/#support1">more <img class="arrow" src="<?php print get_template_directory_uri() . "/assets/images/arrow.png" ?>" alt=""></a>
				</div>
				<div>
					<img src="<?php print wp_upload_dir("2017/08")["url"] . "/main-04.jpg" ?>" alt="">
					<h2>くむ<small>／楽しむ</small></h2>
					<p>伝統工芸から始まる学び、楽しさ、新しさ。<br>
					伝統が持つ魅力と共に、皆様からのご提案もできる限り取り入れた企画を展開していきたいと思っております。<br>
					様々なご提案をお待ちしております。
					</p>
					<a href="./service/#support2">more <img class="arrow" src="<?php print get_template_directory_uri() . "/assets/images/arrow.png" ?>" alt=""></a>
				</div>
			</div>
			...
			<div class="wrap bg100">
				...
				<div class="col">
					...
					<a href="./product/">more <img class="arrow" src="<?php print get_template_directory_uri() . "/assets/images/arrow.png" ?>" alt=""></a>
				</div>
			</div>
			<?php endif; ?>